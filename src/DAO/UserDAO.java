...
public class UserDAO {
	...
	public User findUserByNIE(String NIE) {
	...
	private User mapUser (ResultSet rs) throws SQLException{
		...
		case CUSTOMER:
			...
			user = new Customer(idUser, NIE, name, address, phoneNumber,
		                        email, password, passwordAttempts,
		                        lastConnection, registerDate, role,
		                        0.0);
		    break;

		case EMPLOYEE:
		    user = new Employee(idUser, NIE, name, address, phoneNumber,
		                        email, password, passwordAttempts,
		                        lastConnection, registerDate, role,
		                        0.0,                // salary
		                        null,               // hireDate
		...
		case MANAGER:
		    user = new Admin(idUser, NIE, name, address, phoneNumber,
		                     email, password, passwordAttempts,
		                     lastConnection, registerDate, role,
		                     null);
		    break;
